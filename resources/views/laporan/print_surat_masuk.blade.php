        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12"><center><h2>DINAS PERHUBUNGAN KABUPATEN GARUT<p>Laporan Surat Masuk</p></h2></center></div>
                    </div>
                    <br />
                    <br />
                    <div class="row">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:center; width:15%;vertical-align:middle;">Pengirim</th>
                                        <th style="text-align:center; vertical-align:middle;">Tanggal <br />Surat</th>
                                        <th style="text-align:center; vertical-align:middle;">No <br />Surat</th>
                                        <th style="text-align:center; width:15%; vertical-align:middle;">Perihal</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse ($data_sm as $sm)
                                        <tr>
                                            <td align="center">{{$sm->no_agendasm}}</td>
                                            <td align="center">{{date('d-m-Y', strtotime($sm->tanggal))}}</td>
                                            <td align="center">{{$sm->pengirim}}</td>
                                            <td align="center">{{date('d-m-Y', strtotime($sm->tgl_sm))}}</td>
                                            <td align="center">{{$sm->no_sm}}</td>
